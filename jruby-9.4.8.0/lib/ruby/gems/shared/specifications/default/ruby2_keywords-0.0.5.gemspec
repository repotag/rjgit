...
Gem::Specification.new do |s|
  ...
  s.files = ["ChangeLog".freeze, "LICENSE".freeze, "README.md".freeze, "lib/ruby2_keywords.rb".freeze, "logs/ChangeLog-0.0.0".freeze, "logs/ChangeLog-0.0.1".freeze, "logs/ChangeLog-0.0.2".freeze, "logs/ChangeLog-0.0.3".freeze, "logs/ChangeLog-0.0.4".freeze]
