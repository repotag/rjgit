...
Gem::Specification.new do |s|
  ...
  s.files = [".github/workflows/test.yml".freeze, ".gitignore".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "abbrev.gemspec".freeze, "bin/console".freeze, "bin/setup".freeze, "lib/abbrev.rb".freeze]
