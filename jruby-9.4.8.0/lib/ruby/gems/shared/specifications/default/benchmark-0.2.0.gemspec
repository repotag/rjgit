...
Gem::Specification.new do |s|
  ...
  s.files = [".github/workflows/test.yml".freeze, ".gitignore".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "benchmark.gemspec".freeze, "bin/console".freeze, "bin/setup".freeze, "lib/benchmark.rb".freeze, "lib/benchmark/version.rb".freeze]
