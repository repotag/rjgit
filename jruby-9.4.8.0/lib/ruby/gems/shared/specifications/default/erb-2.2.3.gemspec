...
Gem::Specification.new do |s|
  ...
  s.files = [".github/workflows/test.yml".freeze, ".gitignore".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "NEWS.md".freeze, "README.md".freeze, "Rakefile".freeze, "bin/console".freeze, "bin/setup".freeze, "erb.gemspec".freeze, "lib/erb.rb".freeze, "lib/erb/version.rb".freeze, "libexec/erb".freeze]
