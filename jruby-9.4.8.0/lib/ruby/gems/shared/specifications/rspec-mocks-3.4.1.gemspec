# -*- encoding: utf-8 -*-
# stub: rspec-mocks 3.4.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-mocks-3.4.1".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.4.0"])
    ...
    s.add_dependency(%q<rspec-support>.freeze, ["~> 3.4.0"])
